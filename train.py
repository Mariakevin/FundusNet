...
parser.add_argument("--output", default=SCRIPT_DIR,
                    help="Path to output directory for model files (default: script dir)")
parser.add_argument("--models", nargs="+", default=["efficientnet", "resnet", "squeezenet", "mobilenet", "convnext", "vit"],
...
def train_model(model_name, patience=5):
    print(f"\n{'='*50}")
